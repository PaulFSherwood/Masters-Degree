...
\title{\Huge{MATH-270-45}\\Week 1 Sets, Functions and Relations}
...
\dfn{Sets of Numbers}%$\bs{\bbR}$}
{ $N$ = \{1,2,3,...\} is the set of natural numbers. $Z$ = \{...,-3,-2,-1,0,1,2,3,...\}}

\dfn{Union and Intersection of Sets}%$\bs{\bbR}$}
